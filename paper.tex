...
\begin{definition}[Internal Judgments]
  ...
  A \emph{global internal judgment} is a section
  $\Of{J}{\int_\Upsilon{\Omega^{\mathbbold{1}}}(\Upsilon)}\cong
  \IMode{\int_\Upsilon\Hom{\mathbb{J}}{\Yoneda{\Upsilon}}{\Omega}}$, which can
