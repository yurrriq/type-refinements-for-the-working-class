...
\begin{quote}
  ...
  $\FRMemEq{\Upsilon}{\Psi\rho}{M}{N}{\chi\rho}$, you can conclude
  $\FEqRefines{\Upsilon}{\Psi\rho}{\Subst{M}{x}{\phi\rho}}{\Subst{N}{x}{\psi\rho}}{\tau}$.
  In other words:
  %
  \[
    \infer[\PFunRefSnoc]{
      ...
      \begin{array}{l}
        ...
        \left(\FRMemEq{\Upsilon}{\Psi\rho}{M}{N}{\chi\rho}\right)
        \Rightarrow
        \left(\FEqRefines{\Upsilon}{\Psi\rho}{\Subst{M}{x}{\phi\rho}}{\Subst{N}{x}{\psi\rho}}{\tau}\right)
      \end{array}
    }
  \]
\end{quote}
...
%%
%% Functional equality $\FRMemEq{\Phi}{\Psi}{M}{N}{\phi}$ presupposes
%% $\RefinesCtx{\Phi}{\Upsilon}$, $\RefinesCtx{\Phi}{\Psi}{\Gamma}$,
%% $\FRefines{\Phi}{\Psi}{\phi}{\tau}$, $\IsAbt{\cdot}{\Upsilon}{\Gamma}{M}{\tau}$
%% and $\IsAbt{\cdot}{\Upsilon}{\Gamma}{N}{\tau}$; the judgment is defined by
%% induction on the evidence for the second presupposition
%% $\RefinesCtx{\Phi}{\Psi}{\Gamma}$:
%%
%% \paragraph{Case} $\DefRefinesCtxNil{\Phi}$.
%% \[
%%   \infer{
%%     \FRMemEq{\Phi}{\cdot}{M}{N}{\phi}
%%   }{
%%     \RMemEq{\Phi}{M}{N}{\phi}
%%   }
%% \]
%%
%% \paragraph{Case} $\DefRefinesCtxSnoc{\Phi}{\Psi}{x}{\psi}{\Gamma}{\sigma}$,
%% where $\RefinesCtx{\Phi}{\Upsilon}$.
%% \[
%%   \infer{
%%     \FRMemEq{\Phi}{\Psi,x:\psi}{M}{N}{\phi}
%%   }{
...
%% $\IsSubrefinement{\Phi}{\phi}{\psi}{\tau}$ judgment, and admit a lattice structure
%% at any sort $\tau$.
%%
%% We have the bottom refinement $\GloballyRefines{\TyBot{\tau}}{\tau}$, which simply
%% contains no elements. Next, the top refinement $\GloballyRefines{\TyTop{\tau}}{\tau}$
