...
\begin{definition}[General Judgment]
  ...
  \begin{align*}
    ...
    &\cong
    \OMode{
      \int_{w':\mathcal{W}}{\Hom{\Sets}{\Hom{\mathcal{W}}{w'}{w}}{\int_{\omega:\square\Omega}{\Hom{\Sets}{\mathbbold{1}}{\mathcal{J}(\omega)(w')}}}}
    }
  \end{align*}
...
\begin{definition}[Hypothetical Judgment]
  ...
  \begin{align*}
    ...
    &\cong
    \OMode{
      \int_{w':\mathcal{W}}{\Hom{\Sets}{\Hom{\mathcal{W}}{w'}{w}\times{\mathcal{J}_{2}(w')}}{\mathcal{J}_{2}(w')}}
    }
  \end{align*}
