...
interpreting the types or sorts as (families of) presheaves or sheaves over
contexts of hypotheses, and as such, a proof theoretic interpretation of the
hypothetical judgment is possible.

Secondly, there is the view of type theory as a semi-formal theory of
...
algebra, where the operators are an arity-indexed family of \emph{sets}. The point
...
$\Refines{\Upsilon}{\phi}{\sigma}$, we may construct a number of new refinement
connectives, including the family intersection, the dependent intersection, the
family union, and the set comprehension.
...
In this section we adapt Howe's notion of lazy computation
...
\begin{definition}[Computational Approximation]
  ...
  \[
    \infer{
      ...
      \land\left\{
        \begin{array}{l}
          \Eval{\Upsilon'}{\tau}{\Rename{\rho}{M}}{\App{\vartheta}{\vec{E}}}\\
          \IsCanOperator{\Upsilon'}{\vartheta}{\MkArity{\vec{v}}{\tau}}
        \end{array}
      \right\}
      \implies
      \land\left\{
        \begin{array}{l}
          \Eval{\Upsilon'}{\tau}{\Rename{\rho}{N}}{\App{\vartheta}{\Vec{F}}}\\
          \PBinRel{\preccurlyeq_{\vec{v}}}{\Upsilon'}{\vec{E}}{\vec{F}}
        \end{array}
      \right\}
    }
  \]
...
\begin{tikzcd}[cramped]
  \IMode{\Upsilon,a:\sigma}\arrow[r,hook,"\IMode{\rho}"] &\IMode{\Upsilon'}
\end{tikzcd}%
:
\[
  \infer={
...
\begin{thm}
  Nominal necessity is an idempotent comonadic modality on refinements.
\end{thm}
\begin{proof}
...
\begin{proof}
  ...
  \begin{tikzcd}[cramped]
    \IMode{\Upsilon}\arrow[r,hook,"\IMode{\rho}"] &
    \IMode{\Upsilon'}\arrow[r,hook,"\IMode{\rho'}"] &
    \IMode{\Upsilon''}\equiv\OMode{\Upsilon', \vec{w}:\vec{\sigma}}
  \end{tikzcd}
