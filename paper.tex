...
\begin{definition}[General Judgment]
  ...
  \]
  Let $\Discrete{\square\Omega}$ be the discrete category on $\square\Omega$. Then, for
  any diagram $\Of{\mathcal{J}}{\mathbb{J}^{\Discrete{\square\Omega}}}$, we can
  ...
  \[
    ...
    \Define{
      ...
      \Hom{\mathbb{J}}{
        ...
        \varinjlim_{\Discrete{\square\Omega}}\mathcal{J}
      }
    }
  \]
