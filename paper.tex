...
\begin{definition}[General Judgment]
  ...
  $\Of{\Yoneda{-}}{\mathcal{W}\to\mathbb{J}}$ is the Yoneda Embedding:
   ...
   the body of $\mathcal{J}$, when there is a contextually salient
   $\vec{u}$, we will simply write $\MV{m}$ rather than the more proper
   $\MApp{\MV{m}}{\vec{u}}{\cdot}$.
...
\begin{gather*}
  \infer{
    ...
    \HPGenJ{\Upsilon}{\Gamma}{y,z:\sigma}{
      \HypJ{
        \HEqRefines{\Phi}{\Psi}{
          \Subst{y}{x}{\phi}
        }{
