...
$\EvalN{\Upsilon}{\tau}{n}{M}{N}$.
 ...
 \begin{remark}
   ...
   global internal judgment $\Of{\Downarrow_\tau}{\int_\SCtx
   \Omega^{\Exprs_\tau\times\Values_\tau\times\NaturalsPsh}}$, where
   $\NaturalsPsh$ is the constant presheaf $\MapsTo{\Upsilon}{\Naturals}$.
   Then, we know $\EvalN{\Upsilon}{\tau}{n}{M}{N}$ just when the
   externalization $\Embed{\Downarrow_\tau}(M,N,n)$ is evident at $\Upsilon$.
 \end{remark}
