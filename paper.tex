...
\begin{quote}
  ...
  $\Of{\varrho}{\Upsilon\hookrightarrow\OMode{\Upsilon'}}$, for any $M, N$,
...
When we have $\Refines{\cdot}{\phi}{\tau}$, we say that $\phi$ is an
\emph{global} refinement and may simply write $\GRefines{\phi}{\tau}$. By
weakening, if $\GRefines{\phi}{\tau}$ then for all $\Phi$, we have
