...
$\Of{\pi}{\mathcal{W}\to\SCtx}$ such that $\pi$ is a Grothendieck
...
\[
  \begin{tikzcd}[cramped, ampersand replacement = \&, row sep = large]
    ...
    {}\&
    {\OMode{{w}_{j}}}
      \arrow[phantom, dr, "\scriptstyle{{\ulcorner}_{\mathcal{W}}}", very near start, yshift = +0.2em]
    ...
    {}\&
    {\IMode{{\Upsilon}_{j}}}
      \arrow[phantom, ur, "\scriptstyle{{\llcorner}^{\SCtx}}", very near start, xshift = +0.3em, yshift = -0.2em]
