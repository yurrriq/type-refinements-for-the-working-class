...
%% is a unique $\Of{\psi}{\Hom{\Sets^\SCtx}{\Yoneda{\Upsilon}}{\PERs{\Values_\tau}}}$ such that
...
$\Of{\phi}{\Hom{\Sets^\SCtx}{\Yoneda{\Upsilon}}{\PERs{\Values_\tau}}}$.
...
\[
  \begin{tikzcd}[sep=huge]
    \IMode{\Yoneda{\Upsilon}\times\Values_\tau^2}
      ...
      \arrow[d, swap, "\IMode{\Pair{\ArrId{}}{\iota}}"]
      &
    \IMode{\Omega}\\
    \IMode{\Yoneda{\Upsilon}\times\Exprs_\tau^2}
...
$\PERs{\Values_\tau}\to\PERs{\Exprs_\tau}$, $\VToCType$ is the left adjoint to
the canonical inclusion
$\Of{\iota}{\PERs{\Exprs_\tau}\inj\PERs{\Values_\tau}}$.
\end{thm}
\begin{proof}
  We will exhibit a counit $\Of{\epsilon}{\VToCType\circ\iota\to
  \ArrId{\PERs{\Values_\tau}}}$ and a unit
  $\Of{\eta}{\ArrId{\PERs{\Exprs_\tau}}\to\iota\circ\VToCType}$ for
  the adjunction $\IMode{\VToCType}\dashv\IMode{\iota}$.

  The counit witnesses the fact that for any refinement
  $\Of{\phi}{\PERs{\Exprs_\tau}}$ and terms $\Member{M,N}{\Exprs_\tau}$, if
  ...
  values.  The unit witnesses the fact that for any value PER
...
\begin{definition}[Value Types]
  ...
  terms of our computation types. For any type $\IsType{\Upsilon}{\phi}{\tau}$,
