...
\begin{gather*}
  \infer[\PFunRefSnoc]{
    ...
    \HPGenJ{\Upsilon}{\Gamma}{\MV{m},\MV{n}:\sigma}{
      \HypJ{
        \HEqRefines{\Upsilon}{\Psi}{
          \Subst{\MV{m}}{x}{\phi}
        }{
          \Subst{\MV{n}}{x}{\psi}
        }{\tau}
      }{
        \HRMemEq{\Upsilon}{\Psi}{\MV{n}}{\MV{n}}{\chi}
      }
    }
  }
\end{gather*}
...
\todo[inline]{%
  Is the above a correct rule? I think that it might be good to be explicit
  here rather than using the hypothetico-general judgment. In fact, if we are
  explicit about everything, we can get away with not even explaining the
